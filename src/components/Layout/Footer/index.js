...
const Footer = ({
    ...
    aboutText = "MöbelTaxi Umzug – Der Name, dem Sie beim Umzug vertrauen.",
    contactInfo = [
        { icon: "icon-envolop email-icon", text: "moebeltaxiumzug@gmail.com" },
        { icon: "icon-location location-icon", text: "Zeppelinstraße 75, 13583 Berlin" },
        { icon: "icon-call phone-call", text: "+49 1577 1677034", link: "tel:+49 1577 1677034" }
    ],
    companyLinks = [
    ...
    newsletterText = "Bleiben Sie informiert über unsere neuesten Angebote und Services.",
    bottomMenu = [
        { text: "Terms & Conditions", link: "/about" },
        { text: "Privacy Policy", link: "/privacy-policy" },
        { text: "Contact Us", link: "/contact" }
    ],
    copyrightText = "© 2025 MöbelTaxi Umzug. Alle Rechte vorbehalten."
}) => {
    return (
        <>
            {/*Site Footer Start*/}
